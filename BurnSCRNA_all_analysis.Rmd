...
#         dest = "h5seurat")
# Z:/Lab Huttenlocher/1 Lab Data/Sequencing/ZebraHub/
...
# Might need to separate the two major types (mac/neut) for marker calculation... right now, gpr84 is gone from the candidate list. 
